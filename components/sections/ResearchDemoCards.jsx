...
export default function ResearchDemoCards({ researchDemos }) {
  return (
    <section className="flex flex-col gap-10 p-10 justify-center bg-customBlue">
      <h2 className="flex items-center text-3xl px-14 text-blue-500 font-semibold">研究紹介</h2>
