...
export default function Page() {
  const profileData = {
    backgroundImage: '/member_personal_webpages/members/kenshin/bg.jpg',
  ...
  const researchData = {
    demoUrls: {
      first: {
        ...
        thumbnail: '/member_personal_webpages/members/kenshin/SCAINs_algo.png',
        title: '聞き逃し支援システム',
        video: '/member_personal_webpages/members/kenshin/SCAINs_algo.mp4',
      },
    },
    contents: {
